				...
				if ( $screen->is_block_editor() ) {
					...
					add_action(
						...
						function () use ( $preview_width ) {
							wp_add_inline_style( 'porto-blocks-editor', '.post-type-porto_builder #elementor-switch-mode, .post-type-porto_builder .composer-switch { display: none } .edit-post-visual-editor, .edit-post-visual-editor__content-area > div { background: #333 !important } body .editor-styles-wrapper{width:' . floatval( $preview_width ) . 'px !important;height: auto !important;margin: 30px auto;padding:0 20px 4rem}' );
						},
						1002
					);
