		...
		if ( typeof vc != 'undefined' && vc.atts.colorpicker ) {
			vc.atts.colorpicker.init = function(param, $field) {
				$(".vc_color-control", $field).each(function() {
					...
					$('<div class="vc_alpha-container"><label>Alpha: <output class="rangevalue">' + alpha_val + '%</output></label><input type="range" min="1" max="100" value="' + alpha_val + '" name="alpha" class="vc_alpha-field"></div>').appendTo(value.addClass("vc_color-picker").find(".iris-picker")),
